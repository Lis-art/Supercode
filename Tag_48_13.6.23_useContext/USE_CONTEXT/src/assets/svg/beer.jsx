...
const BeerAnimation = () => {
  return (
    <svg className="svg-beer" version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      width="100%" height="500px" viewBox="0 0 560 960" style={{enableBackground:"new 0 0 560 960"}} xmlSpace="preserve">
